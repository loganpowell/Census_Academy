...
The response for this request is located in the repo [here](https://github.com/CiscoDevNet/census_labs/tree/master/labs/census_labs/assets/shapes/2016-states-API-request.geojson).
