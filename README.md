## Cisco DevNet Learning Labs: Introduction to Census Data for Developers and Analysts
...
These labs can teach you:
* How to pull down and use Census data
* How to search Census variables of interest for specific topics
* How to get statistics from the DataWeb API
* How to use the Tiger services
