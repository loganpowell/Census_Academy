...
-  `<!` <= `chan` (no buffer)
	...
	- fail: walk up to the bar and it's packed! (lots of parked puts/takes), we don't want to wait forever, what can we do? The hostess tells you to try their new "
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxNjA0ODQ2OSwxNjQ5ODc2MTAwLC00ND
