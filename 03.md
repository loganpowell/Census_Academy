...
`close!`         | fnc     | a "closed" sign on the counter/conveyor that ignores new puts (orders). Food on the conveyor (buffer) is allowed to be taken, but pending takes (serves) are 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM1MTQ5MjMzMSwtMTkxMTExMDU1MCwtMT
