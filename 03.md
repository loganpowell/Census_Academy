...
- The best Sushi restaurant in the world, but also known for not being great
...
## Plot
1) `put!` : We want sushi, so we try phone ordering. First, our call isn't answered (they're busy), since no backpressure, our put is dropped
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUwNzUwODI5NCwtNDQ5Njc1OTIwLDMxND
