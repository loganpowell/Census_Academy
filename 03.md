...
"handlers"       | fnc     | used for when you have to wait (park): for orders (puts), a signal you get when your order was put on the conveyor (if buffered) or (if unbuffered) that it was received by the cook. For takes, a signal 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcxMTMxMTczMCwtNjU3MzQzMTksLTE5NT
