...
`put!`           | fnc     | phone order done through a waiter, who could be too busy to take your order (no backpressure). For backpressure, either wrap in a `go` (sit at the sushi bar with th  or 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY3NDE3NDczNiwtMTkxMTExMDU1MCwtMT
