...
-  `>!` => `chan` 
	...
	- The hostess tells us that takeaway orders are only catered to if no other orders are coming in, so she recommends we just eat at the restaurant.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NDgwMDM3MjIsLTQ0OTY3NTkyMCwzMT
