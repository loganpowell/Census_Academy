...
`chan`           | fnc     | A vehicle that serves to coordinate the food from the cook to the customer wihe plate (buffered = on a [conveyor](https://en.wikipedia.org/wiki/Conveyor_belt_sushi) with the order)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MzMwODgzOTMsLTQ0OTY3NTkyMCwzMT
