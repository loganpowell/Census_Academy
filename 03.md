...
2) `take!` : Take away (order at the restaurant ) => Then we go to pick up our food, but since `take!` doesn't park, we have to keep checking to see if the order is ready. Our So, we figure, we're already here, we might as well just eat here.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzkxOTIzMywtNDQ5Njc1OTIwLDMxNDUyND
kwNSwyMzEzMDMyMzEsLTY1NzM0MzE5LC0xOTU2Njc5ODExLDM5
NzM0MDk2MywtMTkxMTExMDU1MCwtMTAyNjQ5NjAxNiwtMTk3MD
UyMzg0LDE2NjczMDEwNDIsLTE1MzAyMjQ4OTMsLTE4Mjc0NDYw
NTAsLTIwMTc5NDA5NDcsNjAwNTE0NjYsLTE5MjU2NzU2MDcsLT
I1MDI0ODc5LDYyNTE1NDUzLC0xNjUyOTM1MDcxXX0=
-->