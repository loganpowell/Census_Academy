...
`put!`           | fnc     | a custom order that has to be done with a waiter, who could be too busy to take your order (no backpressure)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjk0ODUwMzE4LC0xOTExMTEwNTUwLC0xMD
