...
`go-loop`        | mac     | a repeating sequence of orders or gives
...
`put!`           | fnc     | phone order done through a waiter, who could be too busy to take your order (no backpressure). For backpressure, either wrap in a `go` (sit at the sushi bar with the cook or 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MTAxNTkxMDEsLTE5MTExMTA1NTAsLT
