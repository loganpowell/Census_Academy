...
`alts!` | fnc | a (incoming **or** outgoing) fork in the conveyor (alt* are the only ops that works on both sides of the channel
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4Mjc0NDYwNTAsLTIwMTc5NDA5NDcsNj
AwNTE0NjYsLTE5MjU2NzU2MDcsLTI1MDI0ODc5LDYyNTE1NDUz
LC0xNjUyOTM1MDcxXX0=
-->