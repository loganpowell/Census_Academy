...
-  `<!` <= `chan` (no buffer)
	- success: sit at the counter bar and put order in (`>!` = parks) and wait for food (parking `<!`) FIFO `chan`
	- fail: walk up to the bar and it's packed! (lots of parked puts/takes), we don't want to wait forever, what can we do? Buffer!
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDk5MTAzODE1LDE2NDk4NzYxMDAsLTQ0OT
Y3NTkyMCwzMTQ1MjQ5MDUsMjMxMzAzMjMxLC02NTczNDMxOSwt
MTk1NjY3OTgxMSwzOTczNDA5NjMsLTE5MTExMTA1NTAsLTEwMj
Y0OTYwMTYsLTE5NzA1MjM4NCwxNjY3MzAxMDQyLC0xNTMwMjI0
ODkzLC0xODI3NDQ2MDUwLC0yMDE3OTQwOTQ3LDYwMDUxNDY2LC
0xOTI1Njc1NjA3LC0yNTAyNDg3OSw2MjUxNTQ1MywtMTY1Mjkz
NTA3MV19
-->