...
---              | :---:   | ---
`go`             | mac     | like eating at the restaurant (fifo/first-come-first-serve = enables synchronous syntax and back-pressure)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgwODkxNTk0NiwtMTAyNjQ5NjAxNiwtMT
