...
`put!`           | fnc     | order done through a waiter, who could be too busy to take your order (no backpressure). For backpressure, either wrap in a `go` (sit at the convey
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MTQxNDkyODAsLTE5MTExMTA1NTAsLT
