...
### Characters:
- Customers: puts are orders, takes are food
- Cooks: puts are food, takes are orders
...
`dropping-buffer`| fnc     | Cookif the conveyor gets full, they don't accept any new orders
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQxNTM5NjMxNSwtNjU3MzQzMTksLTE5NT
