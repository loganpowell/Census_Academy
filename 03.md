...
`alts!` | fnc | a "valve/switch" in the conveyor (alt* are the only ops that works on both sides of the channel) => dynamic switch (
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTE2ODQ0MDEsLTE4Mjc0NDYwNTAsLTIwMT
c5NDA5NDcsNjAwNTE0NjYsLTE5MjU2NzU2MDcsLTI1MDI0ODc5
LDYyNTE1NDUzXX0=
-->