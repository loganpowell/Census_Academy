...
`take!`          | fnc     | *trying to get sushi as available, without ordering* for sushi (no backpressure) depends on cooks' availability |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjY4MzE4NTc5LDE2NDk4NzYxMDAsLTQ0OT
