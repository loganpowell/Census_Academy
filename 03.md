...
`go` | mac |
`go-loop` | mac |
`alt!` | mac | like a mix of `alts!` with `cond` (switch
`alts!` | fnc | a (incoming **or** outgoing) "valve/switch" in the conveyor (alt* are the only ops that works on both sides of the channel
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5MDIzMTAxMCwtMTgyNzQ0NjA1MCwtMj
AxNzk0MDk0Nyw2MDA1MTQ2NiwtMTkyNTY3NTYwNywtMjUwMjQ4
NzksNjI1MTU0NTMsLTE2NTI5MzUwNzFdfQ==
-->