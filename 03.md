...
"handlers"       | fnc     | Used for when you have to wait (park). As a customer: If at a coveyor (buffered) for orders (puts), a signal you get when your order was put on the conveyor or (if unbuffered) that it was received by the cook.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODQ2NDM0NzIsLTY1NzM0MzE5LC0xOT
...
MjU2NzU2MDcsLTI1MDI0ODc5LDYyNTE1NDUzLC0xNjUyOTM1MD
cxXX0=
-->